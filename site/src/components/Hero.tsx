  ...
  return (
    <section className="relative min-h-[90vh] flex items-center px-6 py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        {/* Text side */}
        <div>
          <p className="text-sm font-medium tracking-wide text-primary mb-4 uppercase">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center justify-center px-8 py-3.5 border border-border text-foreground font-medium rounded-lg hover:bg-card transition-colors"
            >
              How it works
            </a>
          </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
            <div className="absolute inset-0 bg-primary/8 rounded-2xl -rotate-3" />
            ...
            <div className="absolute -bottom-3 -right-3 bg-tier-s text-white text-sm font-bold px-3 py-1.5 rounded-lg">
              S-Tier
            </div>
          </div>
        </div>
